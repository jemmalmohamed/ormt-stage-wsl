...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0installer\windows\setup.ps1" -Mode Full -StageAction "%STAGE_ACTION%" -SourceMode Auto -ProvidedSourcesDir "%~dp0sources"
