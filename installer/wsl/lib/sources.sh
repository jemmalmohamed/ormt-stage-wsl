  ...
  case "$scope" in
    ...
    stage)
      required+=(
        ...
        "ormt-api/ormt-pdf-renderer/package.json"
        "ormt-api/ormt-pdf-renderer/package-lock.json"
        "ormt-api/ormt-pdf-renderer/Dockerfile"
        "ormt-api/ormt-pdf-renderer/src/server.mjs"
