...
check_route "Route Traefik" traefik.localhost
...
if test "$ORMT_INSTALL_DEV_TOOLS" = "true"; then
  ...
  check_route "Route Portainer" portainer.localhost
  check_route "Route Jenkins" jenkins.localhost
  check_route "Route Homepage" lab.localhost
  check_route "Route Grafana" grafana.localhost
  check_route "Route Prometheus" prometheus.localhost
fi
